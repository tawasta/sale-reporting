...
class OrderBookLog(models.Model):
    ...
    sale_order_line = fields.Many2one(string="Sale Order Line", comodel_name="sale.order.line", required=True, readonly=True, store=True)
    ...
    def create_cron_job(self):
        ...
        cron_data = {
            ...
            'model_id': self.env.ref('sale_filter_sale_order_lines.model_order_book_log').id,
            'state': 'code',
