            ...
            rows.append(
                {
                    ...
                    "sale_type": self.env["sale.order"].browse(rec.get("order_id")).sale_type.name if rec.get("order_id") and self.env["sale.order"].browse(rec.get("order_id")).sale_type else None,
