...
async def sale_report(
    ...
    euro = env.ref("base.EUR")
    alt_carrier = env["delivery.carrier"].search(
        [("is_alternative_carrier", "=", True)], limit=1
    )
            ...
            rows.append(
                {
                    ...
                    "country": order.partner_id.country_id.name or "",
                    "commercial_partner": order.partner_id.commercial_partner_id.name
                    or "",
                    "margin": order.margin,
                    "delay": order.delay,
                    ...
                    * line.discount
                    ...
                    "original_sale_id": order.original_sale_id.name
                    if order.original_sale_id
                    else "",
                    "addresses": addresses,
                    "carriers": carriers,
                    "sales_agent": {
